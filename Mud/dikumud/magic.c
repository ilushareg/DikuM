  ...
  struct char_data *victim, struct obj_data *obj)
{
  ...
  tmp_obj->name = strdup_l("mushroom");
  tmp_obj->short_description = strdup_l("A Magic Mushroom");
  tmp_obj->description = strdup_l("A really delicious looking magic mushroom lies here.");
